...
module Engine {
    export class Config {
         ...
         * @static
         */
        public static gameScreenX : number = 800;
         ...
         * @static
         */
        public static gameScreenY : number = 600;
         ...
         * @static
         */
        public static tileWidth : number = 32;
         ...
         * @static
         */
        public static tileTextureWidth : number = 32;
         ...
         * @static
         */
        public static tileTextureHeight : number = 32;
        ...
        public static calculateOffset() : void {
            this.offsetX  = /*(Engine.Config.gameScreenX / 2) - (Engine.Config.tileWidth / 2)*/0;
            this.offsetY = /*Engine.Config.tileHeight*/0;
        }
    }
}